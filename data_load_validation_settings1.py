...
from MyData.Interaction_data import miRNA_mRNA_pairwise_Intrctions
from MyData.miRNA_features import miRNA_pairwise_featuresCombined
from MyData.mRNA_features import mRNA_pairwise_featuresCombined
...
def settingC_split(selected_miRNA_list, selected_mRNA_list):
    ...
    mbs_test_cnt = 400 # select number of mbs for testing
